...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/rendyap100/sshmaxfix/main/izinnya > /root/tmp
...
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/rendyap100/sshmaxfix/main/izinnya | grep $MYIP | awk '{print $2}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/rendyap100/sshmaxfix/main/izinnya | grep $MYIP | awk '{print $3}')
fi
